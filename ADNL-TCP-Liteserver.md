...
可以從[配置文件](https://ton-blockchain.github.io/global.config.json)中獲得伺服器的公開資訊，例如 IP、端口和鑰匙。

在配置文件中，IP 是以數字形式表示的，可以使用像[這樣的工具](https://www.browserling.com/tools/dec-to-ip)將其轉換為正常形式。
